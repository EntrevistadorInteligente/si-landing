...
export const SERVICES_PATH = '/es/pagina-principal/services';
export const SAMPLE_PATH = '/es/pagina-principal/sample';
export const WHO_WE_ARE_PATH = '/es/pagina-principal/who-we-are';
export const COMMUNITY_PATH = '/es/pagina-principal/community';
